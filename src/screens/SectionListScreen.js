      ...
      >
        <View style={{ flex: 1, padding: 12, }}>
          ...
          <View style={{ flexDirection: global.isAndroid ? 'row-reverse' : 'row', padding: 12, width: '100%', justifyContent: "space-between" }}>
            ...
            >
              <Text style={{ ...Fonts.fontRegular, writingDirection: global.isAndroid ? 'rtl' : 'ltr' }}>{`الأوقات المتاحة  `}<FontAwesome name={'calendar'} /></Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => {
              ...
              {item.general_price && < Text style={{ ...Fonts.fontRegular, writingDirection: global.isAndroid ? 'rtl' : 'ltr' }}>{`الأسعار  `}<FontAwesome name={'money'} /></Text>}
            </TouchableOpacity>
          </View>
        </View>
        {
