  ...
  renderHeaderSearch = () => {
    ...
    return (
      <SafeAreaView elevation={5} style={{ ...styles.headerContainer, justifyContent: "space-between", paddingVertical: 20, ...style }}>
        ...
        <TouchableOpacity onPress={() => openDrawer()} style={global.isAndroid ? styles.leftButton : styles.backButton}>
  ...
  const renderMap = () => {
    return (
      <SafeAreaView elevation={5} style={{ ...styles.headerContainer, height: '13%' }}>
        <TouchableOpacity onPress={() => leftButton()} style={global.isAndroid ? styles.backButton : styles.leftButton}>
          <MaterialIcons size={30} color={Colors.primaryBlue} name={'search'} />
        </TouchableOpacity>
        <TouchableOpacity onPress={() => onPressBack()} style={global.isAndroid ? styles.leftButton : styles.backButton}>
